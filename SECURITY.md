...
The **mcptoolkit-editor** maintainers take all security issues in the project
seriously. Thank you for improving the security of **mcptoolkit-editor**. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

**mcptoolkit-editor** leverages GitHub's private vulnerability reporting.
